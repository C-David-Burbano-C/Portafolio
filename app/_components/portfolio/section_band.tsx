...
export default function SectionBand({
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl border border-sky-200 bg-[linear-gradient(135deg,#eff6ff_0%,#dbeafe_38%,#e9d5ff_100%)] px-5 py-5 shadow-[0_22px_56px_-34px_rgba(59,130,246,0.45)] dark:border-slate-800 dark:bg-none dark:bg-gradient-to-r dark:from-teal-950 dark:via-slate-900 dark:to-slate-800 sm:px-6 sm:py-7">
