    ...
    >
      ...
      <div className="mt-6 grid grid-cols-3 gap-2 sm:gap-4 lg:gap-6">
        {skills.map((skill) => (
          <article
            key={skill.title}
            className="bg-slate-900 border-slate-700 relative flex min-h-24 flex-col justify-between overflow-hidden rounded-3xl border p-3 shadow-md sm:min-h-36 sm:p-5 lg:min-h-48 lg:p-6"
          >
            ...
            <h3 className="font-display text-xs font-semibold text-white sm:text-lg lg:text-2xl">
              {skill.title}
            </h3>
