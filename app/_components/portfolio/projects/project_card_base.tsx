  ...
  return (
    <article className="bg-surface flex h-full flex-col rounded-3xl border border-line p-4 shadow-md sm:p-5">
      <div className="bg-base border-line relative h-48 overflow-hidden rounded-2xl border sm:h-44">
        ...
        <div className="border-line bg-surface/90 text-slate-50 absolute bottom-3 left-3 rounded-full border px-3 py-2 text-xs font-semibold shadow-md sm:bottom-4 sm:left-4 sm:px-4 sm:text-sm">
          Preview del proyecto
        </div>
      </div>

      <h3 className="font-display mt-4 text-xl font-semibold text-slate-50 sm:mt-5 sm:text-2xl">
        {title}
      </h3>
      <p className="mt-2 text-sm leading-6 text-slate-200 sm:text-base">
        {summary}
      </p>
      <p className="text-cyan-200 mt-3 text-sm">{tools}</p>
      ...
      <div className="mt-5 flex flex-wrap gap-3">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="border-line rounded-full border px-4 py-2 text-sm font-semibold text-slate-50"
        >
          GitHub
        </a>
      </div>
