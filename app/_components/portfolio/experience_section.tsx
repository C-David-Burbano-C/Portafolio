...
function ExperienceItem({
  ...
  return (
    <article className="relative ml-4 rounded-3xl border border-white/70 bg-[linear-gradient(160deg,rgba(255,255,255,0.95)_0%,rgba(241,245,249,0.9)_100%)] p-4 shadow-[0_18px_46px_-34px_rgba(15,23,42,0.3)] dark:border-slate-700 dark:bg-none dark:bg-slate-900 sm:ml-6 sm:p-6">
      ...
      <p className="mt-2 text-sm text-cyan-700 dark:text-cyan-300 sm:text-base">{company}</p>
      <p className="mt-1 text-sm text-slate-500 dark:text-gray-400 sm:text-base">{dates}</p>
      <p className="mt-3 text-sm leading-7 text-slate-600 dark:text-gray-400 sm:text-base">
        {description}
      </p>
    </article>
  );
...
export default function ExperienceSection() {
  ...
  return (
    <section id="experiencia" className="flex flex-col gap-5 sm:gap-6">
      <div className="relative overflow-hidden rounded-3xl border border-white/65 bg-[linear-gradient(135deg,rgba(255,255,255,0.92)_0%,rgba(224,242,254,0.82)_100%)] px-5 py-5 shadow-[0_18px_50px_-34px_rgba(14,116,144,0.3)] dark:border-slate-700 dark:bg-none dark:bg-slate-900 sm:px-6 sm:py-7">
      ...
      <div className="space-y-2">
        <p className="text-cyan-700 dark:text-cyan-300 text-sm font-medium uppercase tracking-[0.2em]">
          {copy.eyebrow}
        </p>
        <h3 className="font-display text-3xl font-semibold text-slate-900 dark:text-white sm:text-4xl lg:text-5xl">
          {copy.title}
        </h3>
        <p className="text-base text-slate-600 dark:text-gray-400 sm:text-xl">{copy.subtitle}</p>
      </div>
